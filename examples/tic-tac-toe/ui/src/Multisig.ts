...
/**
 * Generate the SuiAddress corresponding to a 1-of-N multi-sig
 * composed of `keys` (all with equal weighting).
 */
export function multisigAddress(keys: PublicKey[]): string {
	// Multisig addresses cannot contain the same public keys multiple
